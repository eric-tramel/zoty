...
| Tool | Description |
|------|-------------|
| `search_library` | BM25-ranked search over title, abstract, and indexed attachment full text, aggregated back to parent items with optional plain-text snippets, attachment counts, and filters for collection or item type |
